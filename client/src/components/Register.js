...
export default class Register extends Component {
    ...
    render() {
        return (
            <form className="reg-box" noValidate={true} id="loginOrRegistrationForm" onSubmit={this.handleSubmit}>
                ...
                <LinkInClass value="Register New User" className="btn" onClick={this.handleSubmit} />
